...
function Icon(props) {
  return (
    <div className='max-w-full bg-[#F1F2F8]  mx-auto px-4 py-10 flex flex-col items-center justify-center text-Stem-Regular font-custom'>
      <div className='flex flex-wrap items-center justify-center gap-24 font-sans'>
