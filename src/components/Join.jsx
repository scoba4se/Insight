...
function Join() {
  return (
    <div className='bg-[#F8F4FF] max-w-screen-xl mx-auto px-4 py-10 flex flex-col md:flex-row items-center text-[#52565C] justify-center'>
      ...
      <div className=' w-full md:w-auto flex flex-col items-c'>
        <h1 className='text-[28px] md:text-[40px] text-[#21212F] font-bold'>
          Join <span className='text-[#000080]'>World's largest</span> learning platform today
        </h1>
        <h2 className='text-[18px] md:text-[24px] my-4'>Start learning by registering for free</h2>
        <p className='text-[14px] md:text-[16px] text-[#6D737A] mb-4'>
        ...
        <button className='bg-[#FFA63A] px-4 py-2 rounded-full mt-6 text-white w-[200px] h-12'>Create an account</button>
      </div>
    </div>
  )
}
